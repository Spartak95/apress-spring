...
CREATE TABLE INSTRUMENT (INSTRUMENT_ID VARCHAR(20) NOT NULL, PRIMARY KEY (INSTRUMENT_ID));
...
CREATE TABLE SINGER_AUDIT (
    ...
    BIRTH_DATE DATE,
    VERSION INT NOT NULL DEFAULT 0,
    CREATED_ВY VARCHAR(20),
    CREATED_DATE TIMESTAMP,
    LAST_MODIFIED_ВY VARCHAR(20),
    LAST_MODIFIED_DATE TIMESTAMP,
    UNIQUE UQ_SINGER_AUDIT_1 (FIRST_NAME, LAST_NAME),
    PRIMARY KEY (ID)
);

CREATE TABLE SINGER_AUDIT_Н (
     ID INT NOT NULL AUTO_INCREMENT,
     FIRST_NAME VARCHAR(60) NOT NULL,
     LAST_NAME VARCHAR(40) NOT NULL,
     BIRTH_DATE DATE,
